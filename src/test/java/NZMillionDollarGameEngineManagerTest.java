...
public class NZMillionDollarGameEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(NZMillionDollarGameEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/MillionDollarRichesIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/MillionDollarRichesIW/InitOutcome.xml").getDocumentElement();
